# polymake package README

This directoy contains the build files for the polymake package, which is part
of the polymake roll. Unique to the polymake roll/package is the bundled 
